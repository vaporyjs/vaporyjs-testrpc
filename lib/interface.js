...
var VmSubprovider = require('@vapormask/web3-provider-engine/subproviders/vm.js');
...
var Interface = {
  ...
  provider: function(options) {
    ...
    engine.addProvider(new GvapDefaults());
    engine.addProvider(new VmSubprovider());
    engine.addProvider(new SolcSubprovider());
    engine.addProvider(gvapApiDouble);
