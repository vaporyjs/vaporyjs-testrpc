...
DelayedBlockFilter.prototype.handleRequest = function(payload, next, end) {
  if (payload.method == "vap_newBlockFilter") return this.handleNewBlockFilter(payload, next, end);
  if (payload.method == "vap_getFilterChanges") return this.handleGetFilterChanges(payload, next, end);
